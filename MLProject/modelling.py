...
def train():
    ...
    # 2. Hapus folder output lama jika ada (Penting untuk Docker Build)
    ...
    # 4. Simpan Model ke Folder Lokal (Syarat Advance)
    # Ini agar perintah 'mlflow models build-docker' bisa membaca modelnya
